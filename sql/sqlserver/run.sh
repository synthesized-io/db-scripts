...
export scripts=("columns_data_types.sql" "constraints.sql" "cyclic_table_references.sql" "databases.sql" "pii_columns.sql" "schemas_relations.sql" "tables.sql" "schemas.sql", "user_permissions.sql", "table_data_types.sql", "user_defined_data_types.sql")
